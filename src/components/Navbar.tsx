    ...
    <nav className="z-50 text-white w-96 flex justify-center items-center font-aleo font-bold text-2xl">
      <div className="backdrop-blur-sm container mx-auto h-20 flex justify-between items-center border border-slate-300 rounded-full">
        <nav className="flex space-x-4 w-full justify-center gap-0">
          <a
            href="/"
            className="w-full m-0 hover:text-red-600 ease-out duration-200 cursor-pointer flex flex-col justify-center items-center gap-2 text-sm"
          >
            <div>
              <Home />
            </div>
          ...
          <a
            href="/Team"
            className="w-full hover:text-red-600 ease-out duration-200 cursor-pointer flex flex-col justify-center items-center gap-2 text-sm"
          >
            <div>
              <Users />
            </div>
